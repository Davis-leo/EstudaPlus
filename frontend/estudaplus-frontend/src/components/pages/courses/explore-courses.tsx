...
export const ExploreCoursesPage = () => {
    ...
    const defaultTags = ["Matemática","Português","ENEM","Física","Química","Biologia","História","Geografia","Informática","Programação","Desenvolvimento Web","Finanças","Carreira","Redação","Concursos"];
