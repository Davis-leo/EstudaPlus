                ...
                <div className="container">
                    <div className="mx-auto max-w-4xl text-center">
                        <Badge className="mb-4" variant="secondary">
                            🚀 Plataforma web de apoio ao aprendizado
                        </Badge>
            ...
            <section className="py-20">
                <div className="container">
                    <div className="mx-auto max-w-2xl text-center">
                        <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">Foco em inclusão digital</h2>
                        <p className="mt-4 text-lg text-muted-foreground">Tenha a melhor experiência de aprendizado online</p>
                    </div>
                    ...
                    <div className="mx-auto mt-16 grid max-w-5xl grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        <Card className="glass-effect">
                            <CardHeader>
                                ...
                                <CardDescription>Conteúdo criado por especialistas</CardDescription>
                            </CardHeader>
                        </Card>
                        <Card className="glass-effect">
                            <CardHeader>
